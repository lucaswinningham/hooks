...
yarn add @babel/cli @babel/core @babel/plugin-transform-runtime @babel/preset-env @babel/preset-react @babel/preset-typescript @babel/runtime @types/node @types/react @types/react-dom babel-loader css-loader style-loader ts-loader ts-node path typescript webpack-cli --dev
